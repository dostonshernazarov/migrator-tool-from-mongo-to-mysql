...
func (OrganizationServiceDemoUses) TableName() string { return "organization-service-demo-uses" }
...
func (PackageItem) TableName() string { return "package-items" }
...
func (PackageActivationBonusPackage) TableName() string { return "package-activation-bonus-packages" }
...
func (BoughtPackage) TableName() string { return "bought-packages" }
...
func (BoughtPackageItem) TableName() string { return "bought-package-items" }
...
func (PaymeTransaction) TableName() string { return "payme-transactions" }
...
func (OrganizationBalanceBinding) TableName() string { return "organization-balance-bindings" }
...
func (CreditUpdates) TableName() string { return "credit-updates" }
...
func (BankPaymentAutoApplyError) TableName() string { return "bank-payments-auto-apply-errors" }
